...
const getPlacement = asyncHandler(async (req, res) => {
    try {
        ...
        if (!college) {
            throw new ApiError(400, 'Invalid college. College must be a string.');
        }
...
const getPlacementCompare = asyncHandler(async (req, res) => {
    try {
        const { year, college , branch } = req.body;
...
export { getPlacement,getPlacementCompare  };
