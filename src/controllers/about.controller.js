...
const placementBranches = asyncHandler(async (req, res) => {
    try {
        const { college } = req.body;
        const filePath = path.join(process.cwd(), `src/data-about/josaa_unique_code_for_placements.json`);
        const jsonData = await fs.readFile(filePath, 'utf8');
        const data = JSON.parse(jsonData);
        ...
        const coure_mapping_jossa = {
            ...
            "MCE" : "Mechanical Engineering with specialization in Automotive Engineering",
            "AE" : "Aerospace Engineering",
            "BT" : "Biotechnology",
            "CSAI" : "Computer Science and Engineering with specialization in Artificial Intelligence",
            "ICE" : "Instrumentation and Control Engineering",
            "MPAE" : "Mechanical Engineering with specialization in Production and Industrial Engineering",
            ...
            "WXyZ12": "Ceramic Engineering and M.Tech Industrial Ceramic 5-Year B.Tech + M.Tech. (Dual Degree) Course",
            "34s678": "Electronics and Communication Engineering (VLSI Design and Technology)",
            "qwertri": "Bio-Technology",
            "q": "Chemical Engineering (Plastic & Polymer)",
            "CST": "Computer Science and Technology",
            "ET": "Electronics and Telecommunication",
            "Ar": "Architecture",
            "M": "Metallurgy",
            "I-CSE-DD": "Int. M.Tech Computer Science and Engineering",
            "ECE-DD": "Int. M.Tech Electronics and Communication Engineering",
            "CSE-DD": "Computer Science and Engineering (Dual Degree)",
            "ECE-SD-DD": "Electronics and Communication Engineering Communication Systems Design (Dual Degree)",
            "VSLI": "Electronics and Communication Engineering VLSI Design (Dual Degree)",
            "ME-AM-DD": "Mechanical Engineering Advanced Manufacturing (Dual Degree)",
            "ME-PD-DD": "Mechanical Engineering Product Design (Dual Degree)",
            "ME-SM": "Mechanical Engineering Smart Manufacturing",
            "CSE-SD-DD": "Computer Science and Engineering Systems Design (Dual Degree)",
            "IT-DD": "Integrated B.Tech. and M.Tech. in IT",
            "IT-MBA": "Integrated B.Tech. IT and MBA",
            "69Q": "Energy Science and Engineering 5-Year B.Tech + M.Tech. (Dual Degree)",
            "1a": "Environmental Science and Engineering 5-Year B.Tech + M.Tech. (Dual Degree)",
            "1b": "Mechanical Engineering 5-Year B.Tech + M.Tech. (Dual Degree)",
            "1c": "Metallurgical Engineering and Materials Science 5-Year B.Tech + M.Tech. (Dual Degree)",
            "1d": "Electrical Engineering 5-Year B.Tech + M.Tech. (Dual Degree)",
            "1e": "Biochemical Engineering and Biotechnology",
            "1f": "Biochemical Engineering and Biotechnology 5-Year B.Tech + M.Tech. (Dual Degree) Course",
            "1g": "Electronics and Communication EngineeringElectronics and Electrical Engineering",
            "1h": "Biotechnology",
            "1i": "Applied Geophysics",
            "1j": "Mineral Engineering",
            "1k": "Bio-Behavioral",
            "1l": "Bio-Engineering",
            "1m": "Chemistry",
            "1n": "Earth Sciences",
            "1o": "Economics",
            "1p": "Mathematics and Scientific Computing",
            "1q": "Physics",
            "1r": "Geology and Geophysics",
            "1s": "Humanities and Social Sciences",
            "1t": "Mathematics",
            "1u": "Exploration Geophysics",
            "1v": "Polymer Science and Engineering",
            "1w": "Geological Technology",
            "1x": "Geophysical Technology",
            "1y": "Applied Mathematics",
            "1z": "Applied Mathematics 5-Year Integrated M.Sc. Course",
            "2a": "Metallurgical and Materials",
            "2b": "Dual Degree BS-MS",
            "2c": "Architecture 5-Year B.Arch. Couse",
...
export { about,photo,seat_matrix,branches,placementBranches };
